...
api.setRecallMessage = function (message,obj){
  ...
  obj.append('<div  class="cell me"><div class="avatar"><img src="/static/images/im/6.jpg" width="30" height="30"></div><div class="cnt">'+message.content.content+'</div></div>')
}
...
api.hungupCall = function () {
  ...
  clibinstance.hungupCall(converType, targetId,ErrorCode.HANGUP);
}
