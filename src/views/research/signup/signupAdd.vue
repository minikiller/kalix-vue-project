      ...
      el-collapse(v-model="activeNames" v-on:change="handleChange")
        el-collapse-item(title="个人信息" name="1")
          div.kalix-form-table
            ...
            div.s-flex
              div.s-flex_item
                el-form-item.kalix-form-table-td(label="笔名" prop="penName" label-width="120px" style="border-right:1px solid #000")
                  el-input(v-model="formModel.penName")
              div.s-flex_item(style="flex:2")
                el-form-item.kalix-form-table-td(label="通讯地址" prop="postalAddress" label-width="120px" )
            ...
            div.s-flex
              ...
              div.s-flex_item(style="flex:2")
                el-form-item.kalix-form-table-td(label="其他联系方式" prop="otherContactWay" label-width="120px")
