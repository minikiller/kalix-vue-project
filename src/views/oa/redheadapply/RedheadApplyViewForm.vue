...
<template lang="pug">
  div.el-form.kalix-form-table(slot="dialogFormSlot")
    ...
    div.s-flex
      el-form-item.s-flex_item.kalix-form-table-td(label="发文类别" v-bind:label-width="labelWidth")
        el-input(v-bind:value="formModel.sealType|getDictName('OA','发文类型')" readonly)
    ...
    div.s-flex
      el-form-item.s-flex_item.kalix-form-table-td(label="发文专管员" v-bind:label-width="labelWidth")
